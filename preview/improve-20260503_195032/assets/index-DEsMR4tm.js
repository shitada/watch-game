...
あわせよう！`,color1:`#E67E22`,color2:`#D35400`,hasLevels:!1}],Pu=class{scene=new An;camera=new To(50,window.innerWidth/window.innerHeight,.1,100);overlay=null;sceneManager;audioManager;sfx;constructor(e,t,n,r){this.saveManager=r,this.sceneManager=e,this.audioManager=t,this.sfx=n,this.camera.position.set(0,0,8),this.scene.background=new Y(8900331);let i=new ko(16777215,.8);this.scene.add(i)}enter(e){this.audioManager.startBGM(`title`),this.buildOverlay()}update(e){}exit(){this.audioManager.stopBGM(),this.overlay?.remove(),this.overlay=null}dispose(){this.exit()}getThreeScene(){return this.scene}getCamera(){return this.camera}needsContinuousRendering(){return!1}buildOverlay(){let e=document.createElement(`div`);e.style.cssText=`
    ...
    `,this.container.appendChild(this.questionEl),this.container.appendChild(this.scoreEl),this.hintEl=document.createElement(`span`),this.hintEl.style.cssText=`background: rgba(255,255,255,0.85); border-radius: 16px; padding: 6px 18px; font-weight: 700; margin-left: 8px;`,this.hintEl.textContent=`💡 0`,this.container.appendChild(this.hintEl),this.streakEl=document.createElement(`span`),this.streakEl.style.cssText=`background: rgba(255,255,255,0.85); border-radius: 16px; padding: 6px 18px; font-weight: 700; margin-left: 8px;`,this.streakEl.textContent=`✨ 0 もようし`,this.container.appendChild(this.streakEl),e.appendChild(this.container)}updateQuestion(e,t){this.questionEl&&(this.questionEl.textContent=`もんだい ${e}/${t}`)}updateScore(e){this.scoreEl&&(this.scoreEl.textContent=`⭕ ${e}`)}updateHints(e){this.hintEl&&(this.hintEl.textContent=`💡 ${e}`)}updateStreak(e){this.streakEl&&(this.streakEl.textContent=`✨ ${e} もようし`)}unmount(){this.container?.remove(),this.container=null,this.questionEl=null,this.scoreEl=null,this.hintEl=null,this.streakEl=null}},Hu=class{container=null;buttons=[];selectCallback=null;disabled=!1;rng;constructor(e){this.rng=e??Math.random}mount(e){this.container=document.createElement(`div`),this.container.style.cssText=`
      ...
      max-width: 500px;
      margin: 0 auto;
    `,e.appendChild(this.container)}setChoices(e){this.container&&(this.container.innerHTML=``,this.buttons=[],this.disabled=!1,e.forEach((e,t)=>{let n=document.createElement(`button`);n.textContent=Lu(e),n.setAttribute(`aria-label`,Lu(e)),n.style.cssText=`
        font-family: 'Zen Maru Gothic', sans-serif;
