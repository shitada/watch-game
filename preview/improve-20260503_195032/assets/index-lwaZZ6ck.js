...
あわせよう！`,color1:`#E67E22`,color2:`#D35400`,hasLevels:!1}],Pu=class{scene=new An;camera=new To(50,window.innerWidth/window.innerHeight,.1,100);overlay=null;sceneManager;audioManager;sfx;constructor(e,t,n,r){this.saveManager=r,this.sceneManager=e,this.audioManager=t,this.sfx=n,this.camera.position.set(0,0,8),this.scene.background=new Y(8900331);let i=new ko(16777215,.8);this.scene.add(i)}enter(e){this.audioManager.startBGM(`title`),this.buildOverlay()}update(e){}exit(){this.audioManager.stopBGM(),this.overlay?.remove(),this.overlay=null}dispose(){this.exit()}getThreeScene(){return this.scene}getCamera(){return this.camera}needsContinuousRendering(){return!1}buildOverlay(){let e=document.createElement(`div`);e.style.cssText=`
    ...
    `,this.scoreEl=document.createElement(`span`),this.scoreEl.style.cssText=`
      ...
      padding: 6px 18px;
      font-weight: 700;
    `,this.container.appendChild(this.questionEl),this.container.appendChild(this.scoreEl),this.streakEl=document.createElement(`span`),this.streakEl.style.cssText=`background: rgba(255,255,255,0.85); border-radius: 16px; padding: 6px 18px; font-weight: 700; margin-left: 8px;`,this.streakEl.textContent=`✨ 0 もようし`,this.container.appendChild(this.streakEl),e.appendChild(this.container)}updateQuestion(e,t){this.questionEl&&(this.questionEl.textContent=`もんだい ${e}/${t}`)}updateScore(e){this.scoreEl&&(this.scoreEl.textContent=`⭕ ${e}`)}updateStreak(e){this.streakEl&&(this.streakEl.textContent=`✨ ${e} もようし`)}unmount(){this.container?.remove(),this.container=null,this.questionEl=null,this.scoreEl=null}},Hu=class{container=null;buttons=[];selectCallback=null;disabled=!1;rng;constructor(e){this.rng=e??Math.random}mount(e){this.container=document.createElement(`div`),this.container.style.cssText=`
      display: grid;
      grid-template-columns: 1fr 1fr;
      gap: 12px;
      padding: 16px;
  ...
  `,!document.getElementById(`notif-anim`)){let e=document.createElement(`style`);e.id=`notif-anim`,e.textContent=`
    ...
    `,document.head.appendChild(e)}return e.appendChild(s),setTimeout(()=>s.remove(),1200)}var qu=class{scene=new An;camera=new To(50,window.innerWidth/window.innerHeight,.1,100);clock3D=null;quizGen=new Iu;correctEffect=new Ru;incorrectEffect=new zu;hintEffect=new Bu;hud=new Vu;choiceButtons=new Hu;homeButton=new Uu;hintButton=null;overlay=null;sceneManager;audioManager;sfx;level=1;questions=[];choices=[];correctIndex=[];currentQuestion=0;correctCount=0;results=[];waitingNext=!1;pendingTimers=[];hintShown=!1;constructor(e,t,n){this.sceneManager=e,this.audioManager=t,this.sfx=n,this.camera.position.set(0,0,8),this.camera.lookAt(0,0,0);let r=new ko(16777215,.6),i=new Oo(16777215,.8);i.position.set(5,5,10),this.scene.add(r,i),this.scene.background=new Y(15268085)}enter(e){this.level=e.level??1;let t=Mu(this.level);this.questions=[],this.choices=[],this.correctIndex=[];for(let e=0;e<t.questionCount;e++){let e=this.quizGen.generateUniqueTime(this.level,this.questions),t=this.quizGen.generateChoices(e,this.level),n=t.findIndex(t=>t.hours===e.hours&&t.minutes===e.minutes);this.questions.push(e),this.choices.push(t),this.correctIndex.push(n)}this.currentQuestion=0,this.correctCount=0,this.results=[],this.waitingNext=!1,this.pendingTimers=[],this.clock3D=new ku,this.scene.add(this.clock3D.group),this.clock3D.group.position.set(0,.8,0),this.clock3D.setShowSeconds(!1),this.buildOverlay(),this.audioManager.startBGM(`play`),this.showQuestion()}update(e){this.clock3D?.update(e),this.correctEffect.update(e),this.incorrectEffect.update(e),this.hintEffect.update(e)}exit(){this.pendingTimers.forEach(e=>clearTimeout(e)),this.pendingTimers=[],this.clock3D&&=(this.scene.remove(this.clock3D.group),this.clock3D.dispose(),null),this.correctEffect.dispose(),this.incorrectEffect.dispose(),this.hintEffect.dispose(),this.audioManager.stopBGM(),this.hud.unmount(),this.choiceButtons.unmount(),this.homeButton.unmount(),this.hintButton?.unmount(),this.overlay?.remove(),this.overlay=null}dispose(){this.exit()}getThreeScene(){return this.scene}getCamera(){return this.camera}buildOverlay(){let e=document.createElement(`div`);e.style.cssText=`
      ...
      justify-content: space-between;
      pointer-events: none;
    `;let t=document.createElement(`div`);t.style.cssText=`pointer-events: none;`,this.hud.mount(t),e.appendChild(t);let n=document.createElement(`div`);n.textContent=`この とけいは なんじかな？🤔`,n.style.cssText=`
      font-family: 'Zen Maru Gothic', sans-serif;
      font-size: clamp(20px, 4vw, 32px);
      font-weight: 700;
      color: #2C3E50;
